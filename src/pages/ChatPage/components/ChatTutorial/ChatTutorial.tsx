        ...
        <div className={styles.tutorialContainer}>
            ...
            <ul className={styles.tutorialStepsList}>
                <li className={styles.tutorialStepsListItem}>
                    <span>Acquire an <a href="https://platform.openai.com/api-keys" className="href">OpenAI API key</a></span>
                </li>
                <li className={styles.tutorialStepsListItem}>
                    <span>
                        <MdKey />
                    ...
                    In such case your key will not be saved anywhere and the app will work as long as the key stays in the form
                </li>
                <li className={styles.tutorialStepsListItem}>
                    <span>
